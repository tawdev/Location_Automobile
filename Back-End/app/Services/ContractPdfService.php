...
class ContractPdfService
{
    ...
    {
        $reservation->loadMissing(['user', 'vehicle.category', 'vehicle.typeVehicule', 'client', 'extras', 'departureConditions', 'departCountry', 'departCity', 'returnCountry', 'returnCity']);
