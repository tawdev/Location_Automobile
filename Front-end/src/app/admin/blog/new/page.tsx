...
import { createAdminBlog, type AdminBlogPayload } from "@/lib/adminBlogsApi";
      ...
      >
        <form
          onSubmit={async (e) => {
            ...
            try {
              ...
              const msg = (e as ApiError)?.message || (e instanceof Error ? e.message : t("admin.blog_create_error"));
              setError(msg);
            } finally {
              setSubmitting(false);
            }
        ...
        >
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            >
              {submitting ? t("admin.creating") : t("admin.create_blog")}
            </button>
            <button
              type="button"
              onClick={() => router.push("/admin/blog")}
