...
export default function VehiculesPage() {
    ...
    <div className="space-y-6">
            ...
            <button
              ...
              className={`px-3.5 py-1.5 rounded-lg text-[13px] font-semibold transition-all duration-200 ${
                selectedSeats.includes(s)
                  ...
                  : "bg-gray-100 dark:bg-[#1e293b]/60 text-gray-600 dark:text-[#94A3B8] hover:bg-gray-200 dark:hover:bg-[#1e293b]"
              }`}
            >
              {s} {t("vehicles.seats")}
            </button>
      ...
      <div>
        ...
        <div className="space-y-2">
          <input
            ...
            className="w-full h-[44px] bg-white dark:bg-[#1e293b]/60 border border-gray-200 dark:border-[#1e293b]/80 rounded-xl px-4 outline-none text-[14px] text-gray-700 dark:text-[#D5DEEF] [color-scheme:light] dark:[color-scheme:dark]"
          />
          <input
            type="date"
            value={returnDate}
      ...
      {hasActiveFilters && (
        <button
          ...
          className="w-full h-11 rounded-xl border border-gray-300 dark:border-[#475569] text-gray-600 dark:text-[#94A3B8] text-[13px] font-semibold hover:bg-gray-100 dark:hover:bg-[#1e293b]/60 transition-all duration-200 flex items-center justify-center gap-2"
        >
          <X className="w-4 h-4" />
  ...
  return (
    <ClientOnly>
      <div className="bg-[#f6f6f8] dark:bg-[#070b14] transition-colors duration-500">
        {/* Banner */}
        <section className="relative pt-24 pb-12 px-8 bg-gradient-to-br from-[#1f4276] to-[#395886] dark:from-[#050a14] dark:to-[#0d1b3e]">
          <div className="max-w-[1280px] mx-auto">
            ...
            <motion.p
              ...
              className="mt-2 text-white/70 text-base max-w-xl"
            >
        ...
        <div className="max-w-[1280px] mx-auto px-8 py-8">
          ...
          <div className="flex items-center justify-between mb-6 lg:hidden">
            ...
            <button
              ...
              className="h-10 px-4 rounded-xl bg-white dark:bg-[#1e293b]/60 border border-gray-200 dark:border-[#1e293b]/80 text-gray-700 dark:text-[#D5DEEF] text-[13px] font-semibold flex items-center gap-2"
            >
          ...
          <div className="flex gap-8">
            ...
            {sidebarOpen && (
              <div className="fixed inset-0 z-50 lg:hidden">
                ...
                <div className="absolute right-0 top-0 bottom-0 w-[320px] max-w-[90vw] bg-white dark:bg-[#0f1729] shadow-2xl overflow-y-auto p-6">
                  <div className="flex items-center justify-between mb-5">
                    <h3 className="text-[13px] font-bold text-gray-700 dark:text-[#D5DEEF] uppercase tracking-[0.12em] flex items-center gap-2">
                      <SlidersHorizontal className="w-4 h-4" />
                      {t("vehicles.filters")}
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="absolute bottom-4 left-4 z-10">
                            ...
                            >
                              <span className="text-[16px] font-extrabold text-[#1f4276] dark:text-[#f39c12]">{v.pricePerDay.toLocaleString()} DH</span>
                            </motion.div>
                          </div>
                        ...
                        >
                          ...
                          <div className="flex items-center gap-3 mt-4 text-[13px] text-gray-600 dark:text-[#94A3B8] flex-wrap flex-1">
                          ...
                          <motion.div
                            className="mt-4 border-t border-[#d5deeF]/50 dark:border-[#1e293b]/80 pt-4 flex items-center justify-between relative overflow-hidden"
                          >
                            <motion.div
