...
export default function CancellationPage() {
  ...
  const policies = [
    ...
    {
      icon: AlertTriangle,
      title: t("terms.s6_list_3"),
      desc: "Des frais peuvent s'appliquer selon le délai et le type de réservation.",
    ...
    },
    {
      icon: CreditCard,
      title: "Remboursement",
      desc: "Les remboursements sont traités sous 5 à 10 jours ouvrés après annulation et crédités sur le moyen de paiement utilisé lors de la réservation.",
    ...
    },
    {
      ...
      desc: "Vous pouvez modifier vos dates sous réserve de disponibilité. Les modifications effectuées plus de 48h à l'avance sont sans frais.",
