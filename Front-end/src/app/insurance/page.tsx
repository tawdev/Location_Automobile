          ...
          <div className="flex justify-between items-start gap-4">
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-[#FF7B00] text-sm font-bold uppercase tracking-[0.2em]">{content.meta.badge}</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-[#FF7B00] tracking-tight leading-tight">
                {content.meta.title}
                <br />
              ...
              <p className="text-[#FF7B00] text-base md:text-lg font-medium mt-4 leading-relaxed">
