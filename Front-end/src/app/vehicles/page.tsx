...
export default function VehiclesPage() {
  ...
  return (
    <RequireAuth>
      <div className="bg-[#f6f6f8] min-h-screen overflow-hidden">
              ...
              {filteredVehicles.map((v, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className="bg-[#edf0f5] rounded-[18px] overflow-hidden shadow-sm cursor-pointer hover:shadow-md transition-shadow"
                  >
                    <div
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between mt-8">
                        ...
                        <button
                          ...
                          className="h-11 px-6 rounded-xl border border-[#6d89b8] text-[#35568b] text-[13px] font-semibold hover:bg-[#35568b] hover:text-white transition"
                        >
                          R&eacute;server
                        </button>
                      </div>
            ...
            <div className="bg-white rounded-xl shadow-2xl max-w-md w-full overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex flex-col gap-5">
                <div className="flex flex-col gap-2">
                  ...
                  <Popover>
                    <PopoverTrigger>
                      <Button variant="outline" className="w-full justify-start text-left font-normal border-[#D5DEEF]">
