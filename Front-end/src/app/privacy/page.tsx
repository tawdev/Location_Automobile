...
import { Shield, Download, ArrowUp, Sparkles } from "lucide-react";
...
export default function PrivacyPage() {
  ...
  useClientMetadata({ title: PAGE_TITLES.privacy[typedLocale] || PAGE_TITLES.privacy.fr });
        ...
        <div className="relative max-w-6xl mx-auto px-5 sm:px-6 py-14">
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-[#FF7B00] text-sm font-bold uppercase tracking-[0.2em]">{t("legal.badge_privacy")}</span>
            </div>
