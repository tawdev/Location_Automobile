...
import { catKeys, pressReleases } from "@/lib/data/press";
          ...
          <div className="relative flex flex-col md:flex-row md:items-center gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs text-[#638ECB] dark:text-[#94A3B8]">May 12, 2026</span>
              </div>
              <h2 className="text-xl md:text-2xl font-bold text-[#395886] dark:text-[#D5DEEF] group-hover:text-[#f39c12] transition-colors">
                CarForFar Raises $12M Series A to Expand Across North Africa
              </h2>
              <p className="text-sm text-[#638ECB] dark:text-[#94A3B8] mt-2 max-w-2xl">
                The Moroccan car rental startup plans to triple its fleet and launch in Tunisia and Algeria by 2027. This marks the largest Series A in Moroccan mobility tech.
              </p>
            </div>
            <motion.button
              whileHover={{ x: 4 }}
              onClick={() => router.push(`/company/press/${pressReleases[0].slug}`)}
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1 md:hidden">
                  ...
                  <span className="text-xs text-[#638ECB] dark:text-[#94A3B8]">{item.date}</span>
                </div>
