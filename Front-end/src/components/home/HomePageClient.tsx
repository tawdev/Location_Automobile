  ...
  if (forceDark) {
    return (
      <div className={`flex items-center ${className ?? ""}`}>
        <Image src="/logo-dark.png" alt="CARFORFAR logo" width={500} height={144} className="h-14 sm:h-36 w-auto object-contain select-none" unoptimized />
      </div>
    );
  }
  return (
    <div className={`flex items-center ${className ?? ""}`}>
      <Image src="/logo.png" alt="CARFORFAR logo" width={500} height={144} className="h-14 sm:h-36 w-auto object-contain select-none dark:hidden" unoptimized />
      <Image src="/logo-dark.png" alt="CARFORFAR logo" width={500} height={144} className="h-14 sm:h-36 w-auto object-contain select-none hidden dark:block" unoptimized />
    </div>
  );
}
