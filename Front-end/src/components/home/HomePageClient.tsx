          ...
          <div className="flex justify-center mb-8">
            <div className="bg-black/40 backdrop-blur-md rounded-2xl px-8 py-5">
              <m.h1
                ...
                className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black leading-[1.05] tracking-[-0.03em] text-[#ff8d21] text-center"
              >
                {t("home.hero.title1")}{' '}
                <span className="text-[#ff8d21]">{t("home.hero.title2")}</span>
              </m.h1>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 items-start">
              ...
              >
                <span className="inline-flex items-center gap-2.5 bg-white/10 backdrop-blur-md text-white/90 text-[11px] font-bold tracking-[0.2em] uppercase px-5 py-2 rounded-full border border-white/20">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#ff8d21]" />
                  {t("home.badge")}
                </span>
              </m.div>
              ...
              >
                <form onSubmit={handleSearch} className="bg-black backdrop-blur-xl border border-white/10 rounded-2xl p-5 md:p-6 shadow-[0_12px_40px_-8px_rgba(0,0,0,0.4)]">
                      ...
                      <PopoverTrigger className="w-full">
                       ...
                       <PopoverContent align="start" sideOffset={4} className="min-w-[320px] p-3 max-h-96 overflow-y-auto">
                         ...
                         {(() => {
                          ...
                          if (locs) {
                            return locs.map(loc => (
                              <button key={loc.id} type="button" onClick={() => handleReturnLocationSelect(loc.type, loc.name, loc.price)} className={`w-full flex items-center gap-4 px-5 py-4 text-base rounded-xl transition-all ${returnLocationType === loc.type ? "bg-[#ff8d21]/20 text-[#ff8d21]" : "text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700"}`}>
                                <div className={`w-11 h-11 rounded-xl flex items-center justify-center shrink-0 ${loc.type === "airport" ? "bg-gradient-to-br from-[#ff8d21]/20 to-[#ff8d21]/5" : "bg-gradient-to-br from-blue-500/20 to-blue-500/5"}`}>
                                  {loc.type === "airport" ? (
                                    <svg width="22" height="22" viewBox="0 0 24 24" fill="#ff8d21" className="opacity-90"><path d="M21 16v-2l-8-5V3.5c0-.83-.67-1.5-1.5-1.5S10 2.67 10 3.5V9l-8 5v2l8-2.5V19l-2 1.5V22l3.5-1 3.5 1v-1.5L13 19v-5.5l8 2.5z" /></svg>
                                  ) : (
                          ...
                          return (
                            <>
                              <button type="button" onClick={() => handleReturnLocationSelect("airport", t("vehicles.location_airport"), 0)} className={`w-full flex items-center gap-4 px-5 py-4 text-base rounded-xl transition-all ${returnLocationType === "airport" ? "bg-[#ff8d21]/20 text-[#ff8d21]" : "text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700"}`}>
                                <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-[#ff8d21]/20 to-[#ff8d21]/5 flex items-center justify-center shrink-0">
                                  <svg width="22" height="22" viewBox="0 0 24 24" fill="#ff8d21" className="opacity-90"><path d="M21 16v-2l-8-5V3.5c0-.83-.67-1.5-1.5-1.5S10 2.67 10 3.5V9l-8 5v2l8-2.5V19l-2 1.5V22l3.5-1 3.5 1v-1.5L13 19v-5.5l8 2.5z" /></svg>
                                </div>
                                <div className="flex flex-col">
                  ...
                  {(() => {
                    ...
                    if (!fee) return null;
                    return (
                      <div className="mb-3 flex items-center gap-2 bg-[#ff8d21]/10 border border-[#ff8d21]/20 rounded-xl px-4 py-3">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="#ff8d21"><path d="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z"/></svg>
                        <span className="text-sm font-bold text-[#ff8d21]">
                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4" onClick={() => setConfirmOpen(false)}>
                      <div className="bg-[#1a1f2e] border border-white/10 rounded-2xl shadow-2xl max-w-sm w-full p-6" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center gap-3 mb-4">
                          <div className="w-10 h-10 rounded-xl bg-[#ff8d21]/20 flex items-center justify-center">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="#ff8d21"><path d="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z"/></svg>
                          </div>
                          <h3 className="text-lg font-bold text-white">Supplément de restitution</h3>
                        </div>
                        <p className="text-sm text-white/70 mb-6 leading-relaxed">
                          Un supplément de <span className="font-bold text-[#ff8d21]">{confirmData.price.toFixed(2)} DH</span> sera ajouté pour la restitution à <span className="font-bold text-white">{confirmData.name}</span>.
                        </p>
                        <div className="flex gap-3">
                          <button
                            type="button"
                            onClick={() => { setReturnLocationType(confirmData.type); setConfirmOpen(false); setConfirmData(null); }}
                            className="flex-1 h-11 rounded-xl bg-[#ff8d21] hover:bg-[#d68910] text-[#395886] font-bold text-sm transition-all active:scale-95 cursor-pointer"
                          >
                            Confirmer
                          </button>
                          <button
                    ...
                    <div>
                      ...
                      <Popover>
                        ...
                        <PopoverContent align="start" sideOffset={4} className="min-w-[240px] p-3 max-h-72 overflow-y-auto">
                          ...
                          {brandTypes.map(tv => (
                            <button key={tv.id} type="button" onClick={() => setTypeVehiculeId(tv.id)} className={`w-full flex items-center gap-3 px-4 py-3 text-base rounded-xl transition-all ${typeVehiculeId === tv.id ? "bg-[#ff8d21]/20 text-[#ff8d21]" : "text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700"}`}>
                    ...
                    <div>
                      ...
                      <Popover open={modelOpen} onOpenChange={setModelOpen}>
                        ...
                        <PopoverContent align="start" sideOffset={4} className="min-w-[200px] p-3 max-h-72 overflow-y-auto">
                          ...
                          {brandModels.map((m) => (
                            <button key={m} type="button" onClick={() => { setModel(m); setModelOpen(false); }} className={`w-full flex items-center gap-3 px-4 py-3 text-base rounded-xl transition-all ${model === m ? "bg-[#ff8d21]/20 text-[#ff8d21]" : "text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700"}`}>
                      ...
                      <Popover>
                        ...
                        <PopoverContent align="start" sideOffset={4} className="min-w-[240px] p-3 max-h-72 overflow-y-auto">
                          ...
                          {[["Gasoline","Essence"],["Diesel","Diesel"],["Electricity","Électrique"],["Hybrid","Hybride"]].map(([val,label]) => (
                            <button key={val} type="button" onClick={() => setFuelType(val)} className={`w-full flex items-center gap-3 px-4 py-3 text-base rounded-xl transition-all ${fuelType === val ? "bg-[#ff8d21]/20 text-[#ff8d21]" : "text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700"}`}>
                          ...
                          {categories.map((cat) => (
                            <button
                              ...
                              className={`flex-shrink-0 flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium transition-all whitespace-nowrap ${
                                vehicleType === cat.id
                                  ? "bg-[#ff8d21] text-[#395886] shadow-lg shadow-[#ff8d21]/20"
                  ...
                  <div className="mt-3 flex flex-col sm:flex-row gap-3">
                    ...
                    <m.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={handleSearch} className="h-11 px-8 rounded-xl bg-[#ff8d21] hover:bg-[#d68910] text-[#395886] font-bold text-sm flex items-center justify-center gap-2 transition-all shrink-0 shadow-lg shadow-[#ff8d21]/20">
                ...
                {noResults && (
                  <m.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="mt-4 bg-black backdrop-blur-md border border-[#ff8d21]/30 rounded-xl px-5 py-4 text-center"
                  >
                    <p className="text-[#ff8d21] font-semibold text-sm">{t("home.no_results")}</p>
              ...
              {displayVehicles.length > 0 && (
                ...
                >
                  <div className="relative w-full max-w-[700px] mx-auto">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] aspect-square rounded-full border border-[#ff8d21]/10" style={{animation:'pulse-ring 3s ease-in-out infinite'}} />
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[75%] aspect-square rounded-full border border-[#ff8d21]/15" style={{animation:'pulse-ring 3s ease-in-out infinite 0.5s'}} />
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[60%] aspect-square rounded-full bg-[#ff8d21]/[0.04] blur-[60px]" />
                    <div className="absolute top-1/2 left-1/2 w-[70%] aspect-square rounded-full border border-[#ff8d21]/10 z-0 pulse-scale" />
                    <div className="absolute top-1/2 left-1/2 w-[60%] aspect-square rounded-full border border-[#ff8d21]/10 z-0 pulse-scale-reverse" />
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] aspect-square rounded-full bg-[#ff8d21]/[0.06] blur-[70px] z-0 pointer-events-none" />
                          ...
                          >
                            <div className="aspect-[16/9] bg-[#F0F3FA]/10 overflow-hidden relative">
                              ...
                              <div className="absolute top-3 left-3 flex flex-wrap gap-2">
                                ...
                                <span className="text-[11px] font-bold text-white bg-[#ff8d21]/80 backdrop-blur-sm px-2.5 py-1 rounded-full">{displayVehicles[vehicleIndex]?.fuelType}</span>
                              </div>
                            ...
                            <div className="p-5 flex items-center justify-between">
                              ...
                              <div className="bg-[#ff8d21] hover:bg-[#d68910] text-[#395886] text-sm font-black px-5 py-3 rounded-xl transition-colors">Réserver</div>
                            </div>
                          </div>
                          </div>
                        </m.div>
                      ...
                      {displayVehicles.map((_, i) => (
                        <button
                          ...
                          className={`rounded-full transition-all duration-500 ${
                            i === vehicleIndex
                              ? "w-6 h-1.5 sm:w-8 sm:h-2 bg-[#ff8d21]"
        ...
        >
          ...
          >
            <svg width="24" height="36" viewBox="0 0 24 36" fill="none">
              ...
              <circle cx="12" cy="12" r="3" fill="#ff8d21" />
            </svg>
          </div>
        </div>
      </div>
...
function ServicesSection() {
  ...
  return (
    <section className="bg-[#F0F3FA] dark:bg-[#070b14] py-28 px-8 relative overflow-hidden transition-colors duration-500">
      ...
      <div className="absolute bottom-40 right-16 text-[#ff8d21]/10 dark:text-[#ff8d21]/5 text-4xl pointer-events-none" style={{ animation: 'float-drift 12s ease-in-out infinite' }}>&#9679;</div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <span className="inline-flex items-center gap-2 text-[#ff8d21] text-xs font-bold tracking-[0.25em] uppercase bg-[#ff8d21]/10 px-4 py-2 rounded-full border border-[#ff8d21]/20">{t("home.services.badge")}</span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((svc, i) => (
            ...
            >
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#D5DEEF] to-[#c5d0e4] dark:from-[#1e293b] dark:to-[#253249] flex items-center justify-center text-[#395886] dark:text-[#D5DEEF] mb-6 transition-all duration-500 group-hover:from-[#395886] group-hover:to-[#2d4670] dark:group-hover:from-[#ff8d21] dark:group-hover:to-[#d68910] group-hover:text-white group-hover:shadow-[0_8px_25px_rgba(57,88,134,0.3)] dark:group-hover:shadow-[0_8px_25px_rgba(255,141,33,0.3)]">
                <m.div
                  initial={{ rotate: 0 }}
              ...
              <h3 className="text-lg font-bold text-[#395886] dark:text-[#D5DEEF] mb-3 transition-all duration-300 group-hover:text-[#ff8d21] group-hover:translate-x-1">{t(svc.titleKey)}</h3>
              <p className="text-sm text-[#638ECB] dark:text-[#94A3B8] leading-relaxed mb-4">{t(svc.descKey)}</p>
              <div className="flex items-center gap-2 text-[#ff8d21] text-xs font-bold opacity-0 group-hover:opacity-100 transition-all duration-300 -translate-x-2 group-hover:translate-x-0">
...
function HowItWorksSection() {
  ...
  return (
    <section className="bg-white dark:bg-[#0b1121] py-28 px-8 relative overflow-hidden transition-colors duration-500">
      ...
      <div className="absolute bottom-0 left-1/4 w-64 h-64 bg-[#ff8d21]/5 dark:bg-[#ff8d21]/[0.03] rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <m.div
          ...
          className="text-center mb-16"
        >
          <span className="inline-flex items-center gap-2 text-[#ff8d21] text-xs font-bold tracking-[0.25em] uppercase bg-[#ff8d21]/10 px-4 py-2 rounded-full border border-[#ff8d21]/20">{t("home.how.badge")}</span>
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <m.div
                ...
                className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#395886] to-[#2d4670] flex items-center justify-center text-[#ff8d21] text-xl font-black mb-6 relative z-10 shadow-[0_8px_25px_rgba(57,88,134,0.2)] transition-all duration-500 group-hover:shadow-[0_12px_40px_rgba(57,88,134,0.4)]"
              >
                <m.span
                  initial={{ scale: 0 }}
                  whileInView={{ scale: 1 }}
                ...
                <m.div
                  ...
                  className="absolute inset-0 rounded-2xl ring-2 ring-[#ff8d21]/30"
                />
              </m.div>

              {/* Content */}
              <m.h3
                className="text-xl font-bold text-[#395886] dark:text-[#D5DEEF] mb-3 transition-all duration-300 group-hover:text-[#ff8d21]"
              ...
              <m.div
                ...
                className="mt-6 h-0.5 w-12 rounded-full bg-gradient-to-r from-[#638ECB] to-[#ff8d21] origin-left"
              />
            </m.div>
          ))}
        </div>
...
function StatsSection() {
  ...
  return (
    <section className="bg-[#395886] dark:bg-[#0b1121] py-24 px-8 relative overflow-hidden transition-colors duration-500">
      ...
      />
      <div
        className="absolute -bottom-48 -left-48 w-[500px] h-[500px] rounded-full border border-[#ff8d21]/10 dark:border-[#ff8d21]/5"
          ...
          {STAT_KEYS.map((stat, i) => (
            ...
            >
              <m.div
                ...
                className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-white/5 border border-white/10 mb-5 transition-all duration-500 group-hover:bg-[#ff8d21]/20 group-hover:border-[#ff8d21]/30 group-hover:shadow-[0_0_30px_rgba(255,141,33,0.15)]"
              >
                <m.span
                  ...
                  className="text-3xl md:text-4xl font-black text-[#ff8d21] block"
                >
...
function VehicleFeature({ icon, label }: { icon: React.ReactNode; label: string }) {
  return (
    <m.span
      ...
      whileHover={{ scale: 1.1, color: "#ff8d21" }}
...
function VehiclesMarquee({ vehicles: propVehicles = [], marques: propMarques = [] }: { vehicles?: Vehicle[]; marques?: Marque[] }) {
  ...
  return (
    <section className="bg-[#B0B0B0] py-28 px-8 overflow-hidden relative transition-colors duration-500">
      ...
      >
        <div className="text-center">
          <span className="inline-flex items-center gap-2 text-[#ff8d21] text-xs font-bold tracking-[0.25em] uppercase bg-[#ff8d21]/10 px-4 py-2 rounded-full">
                  ...
                  >
                    <div className="h-64 bg-[#F0F3FA] dark:bg-[#1e293b] overflow-hidden relative">
                      ...
                      <div className="absolute top-3 left-3 flex flex-wrap gap-2">
                        ...
                        <m.span
                          ...
                          className="text-[11px] font-bold text-white bg-[#ff8d21]/80 backdrop-blur-sm px-2.5 py-1 rounded-full"
                        >
                          {v.fuelType}
                        </m.span>
                        {v.category && (
                    ...
                    <div className="p-5 overflow-hidden relative">
                      ...
                      <div className="flex items-center gap-2 mb-3 relative z-10">
                        ...
                        <h3 className="text-lg font-bold text-[#395886] dark:text-[#D5DEEF] group-hover:text-[#ff8d21] transition-colors duration-300 leading-tight">
                          {v.model}
                        </h3>
                      </div>
          ...
          >
            {duplicated.map((marque, i) => (
              ...
              >
                ...
                <span className="text-base font-bold text-[#395886] dark:text-[#D5DEEF] text-center transition-colors duration-300 group-hover:text-[#ff8d21]">
                  {marque.name}
                </span>
              </m.div>
            ))}
  ...
  return (
    <section className="bg-[#D5DEEF] dark:bg-[#0b1121] py-32 px-8 relative overflow-hidden transition-colors duration-500">
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, #D5DEEF, #b0c4de, #ff8d21, #395886, #D5DEEF)',
      ...
      <div className="absolute top-16 left-1/4 w-4 h-4 rounded-full bg-[#ff8d21]/40 pointer-events-none" style={{ animation: 'float-slow 5s ease-in-out infinite' }} />
      ...
      <div className="absolute top-1/2 right-1/4 w-5 h-5 border-2 border-[#ff8d21]/20 pointer-events-none" style={{ animation: 'spin-slow 20s linear infinite', transformOrigin: 'center' }} />
      ...
      {[...Array(6)].map((_, i) => (
        <div
          key={i}
          className="absolute w-1.5 h-1.5 rounded-full bg-[#ff8d21]/40 pointer-events-none"
          style={{
            top: `${15 + i * 12}%`,
            left: `${10 + i * 15}%`,
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          <m.span
            ...
            className="inline-flex items-center gap-2 text-[#ff8d21] text-xs font-bold tracking-[0.25em] uppercase bg-white/70 dark:bg-[#1e293b]/80 backdrop-blur-sm px-4 py-2 rounded-full border border-[#ff8d21]/20 shadow-[0_2px_10px_rgba(255,141,33,0.1)] dark:shadow-[0_2px_10px_rgba(255,141,33,0.05)]"
          >
            <m.span
              animate={{ scale: [1, 1.3, 1] }}
              transition={{ repeat: Infinity, duration: 2 }}
              className="w-1.5 h-1.5 rounded-full bg-[#ff8d21]"
            />
            {t("home.cta.ready")}
          </m.span>
          ...
          >
            ...
            <span className="relative inline-flex items-center">
              ...
              />
              <m.span
                className="absolute -bottom-1 left-0 right-0 h-1 bg-[#ff8d21]/20 rounded-full"
                initial={{ scaleX: 0 }}
                whileInView={{ scaleX: 1 }}
                viewport={{ once: true }}
          ...
          >
            ...
            <m.div
              className="absolute inset-0 rounded-2xl border-2 border-[#395886]/30 dark:border-[#ff8d21]/30"
...
function AboutSection() {
  ...
  return (
    <section className="bg-[#f7f7fa] dark:bg-[#0b1121] py-28 border-t border-[#ebedf2] dark:border-[#1e293b]/60 relative overflow-hidden transition-colors duration-500">
      ...
      {/* Decorative circles */}
      <div className="absolute top-20 right-20 w-72 h-72 rounded-full border border-[#1f4276]/5 dark:border-[#ff8d21]/5 pointer-events-none" style={{ animation: 'float-slow 12s ease-in-out infinite' }} />
      <div className="absolute bottom-20 left-20 w-48 h-48 rounded-full border border-[#ff8d21]/8 dark:border-[#638ECB]/8 pointer-events-none" style={{ animation: 'float-drift 15s ease-in-out infinite' }} />
      <div className="absolute top-1/3 left-1/4 w-4 h-4 rounded-full bg-[#1f4276]/10 dark:bg-[#ff8d21]/10 pointer-events-none" style={{ animation: 'twinkle 3s ease-in-out infinite' }} />
      ...
      <div className="max-w-[1280px] mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
        ...
        >
          ...
          <div className="w-16 h-1 bg-[#ff8d21] rounded-full mt-6" />
          ...
          <div className="flex gap-16 mt-14">
            {[
              ...
              >
                <m.div
                  className="text-[56px] font-extrabold text-[#1f4276] dark:text-[#ff8d21] leading-none"
